...
ActiveRecord::Schema.define(version: 20171121103114) do
  ...
  create_table "apartments", force: :cascade do |t|
    ...
    t.index ["landlords_id"], name: "index_apartments_on_landlords_id"
    t.index ["tenants_id"], name: "index_apartments_on_tenants_id"
  end
  ...
  add_foreign_key "apartments", "landlords", column: "landlords_id"
  add_foreign_key "apartments", "tenants", column: "tenants_id"
